...
IMAGE_FOLDER_PATH = r"fingeprints"



ORACLE_DSN = "seu dsn oracle"
...
TABLE_OPERADORES = "DETRAN.OPERADORES" # Tabela de operadores, mudem o nome pro real
...
class LoginScreen(ctk.CTkFrame):
    ...
    def login(self):
        username = "rj0"+self.user_entry.get()
